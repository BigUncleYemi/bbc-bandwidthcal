      ...
      <div className={classes.root}>
        ...
        <div>
          {this.state.activeStep === steps.length ? (
            ...
            <div>
              <div className={`${classes.instructions} my-5 mx-auto`}>{getStepContent(activeStep, this.handleChange, this.state, this.handleClick, this.handleHeavyData, this.handleStream, this.setNumberUser, this.props)}</div>
              <div>
                <Button
